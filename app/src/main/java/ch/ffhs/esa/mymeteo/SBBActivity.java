...
public class SBBActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private void setBrowser() {
        ...
        String url = "https://www.sbb.ch/de/kaufen/pages/fahrplan/fahrplan.xhtml?suche=true&ab=true&language=de&vias=%5B\"\"%5D&webshopPreviewMode=&von="+locationFrom+"&nach="+locationTo;
